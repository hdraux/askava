...
export const PROMPT_LIBRARY: PromptEntry[] = [
  {
    ...
    sequenceTag: "Step 1",
    when:
      "Run first on almost any output. Asks the model to argue against itself — can surface weaknesses that were not explicit in the original answer.",
    note:
      "A weak critique is still informative, but ambiguous: it may reflect confidence, poor instruction following, or limited ability to evaluate the answer.",
  ...
  },
  {
    ...
    sequenceTag: "Step 1",
    when:
      "Use when you want to know where the weak spots are before acting. Useful as an initial probe when you have no source to check against, but not a substitute for external verification.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 2",
    when:
      "Use when the output involves reasoning or recommendations. Can expose assumptions the model may have filled in without being told explicitly.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 2",
    when:
      "Use when you're unsure if the output reflects the question or just the phrasing. Meaningful differences can be a warning sign, especially when the task should yield a stable answer.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 3",
    when:
      "Use for any output involving calculations, multi-step reasoning, or logical inference. Produces an explicit step-by-step explanation that you can inspect, even though it may not reflect the model's actual internal reasoning.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 3",
    when:
      "Use when you have at least one fact in the output whose correct answer you already know. Gives you a limited reliability signal from a verified anchor.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 3",
    when:
      "Use when you have source material the AI was meant to draw from. Helps identify what may have been dropped, added, or changed in meaning.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 3",
    when:
      "Use when the output was meant to follow specific rules, policies, or formatting criteria. Checks the output against stated criteria, criterion by criterion.",
    note:
  ...
  },
  {
    ...
    sequenceTag: "Step 3",
    when:
      "Use for any output containing numbers, calculations, or quantitative analysis. Attempts to redo the calculation step by step from the provided inputs.",
    note:
